# src/cli.py - ENHANCED VERSION with TUNE mode, Enhanced Transformer and INFERENCE support
"""Enhanced command-line interface with TUNE mode, Enhanced Transformer and INFERENCE support."""
...
# INFERENCE import - NEW!
from .inference.predictor import run_inference_cli

def parse_arguments() -> argparse.Namespace:
    """Parse command-line arguments with Enhanced Transformer, TUNE and INFERENCE support."""
    parser = argparse.ArgumentParser(
        description='Modular Multi-Pair LSTM/Enhanced Transformer System with Advanced Tuning and Inference',
...
def validate_transformer_args(args):
    ...
    if getattr(args, 'command', None) == 'inference':
        return args
...
def main():
    ...
    elif args.command == 'inference':  # NEW!
...
def run_inference_pipeline(args):
    ...
    try:
        results = run_inference_cli(
            ...
            cache_enabled=args.cache  # ✅ FIXED: Now properly supported
        )
