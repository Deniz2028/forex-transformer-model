...
class EnsembleTrainer:
    ...
    def _get_training_params(self, config: Dict, model_index: int) -> Dict[str, Any]:
        """
        Return only those keyword arguments that UnifiedTrainer.train_model()
        gerçekten bekliyor: batch_size, learning_rate, weight_decay, patience.
        Augmentation veya label_smoothing gibi UnifiedTrainer’da tanımsız
        parametreler gönderilmez.
        """
